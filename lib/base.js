...
class WebpackBaseBuilder extends Config {
  ...
  combineWebpackConfig() {
    ...
    if (this.utils.isFunction(this.outerConfig.customize)) {
      return this.outerConfig.customize.call(this, webpackConfig) || webpackConfig;
    }
    this.t4 = Date.now();
    this.logger.cost();
