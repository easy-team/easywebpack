...
class WebpackBaseBuilder {
  ...
  initConfig() {
    ...
    this.dependencies = this.utils.getDeps(this.config.dynamicDependencies, pkg.fullDependencies);
  }
  ...
  createWebpackLoader() {
    ...
    const loaders = this.createLoader(this.loaders);
    const modules = this.options.resolveLoader && this.options.resolveLoader.modules;
    this.utils.installLoader(loaders, this.dependencies, modules);
    return loaders;
  }
  ...
  createWebpackPlugin() {
    ...
    const modules = this.options.resolveLoader && this.options.resolveLoader.modules;
    this.utils.installPlugin(this.plugins, this.dependencies, modules);
