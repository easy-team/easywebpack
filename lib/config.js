...
class Config {
  ...
  mergeWebpackConfig(sourceWebpackConfig = {}, newWebpackConfig = {}) {
    ...
    sourceKeys.forEach(key => {
      ...
      } else if (utils.isObject(sourceValue) || Array.isArray(sourceValue)
        || utils.isObject(newValue) || Array.isArray(newValue)) {
  ...
  setPublicPath(publicPath, isOverride = true) {
    ...
    if (this.utils.has(publicPath)) {
      ...
      if (this.dev && this.utils.isTrue(this.config.useHost)) {
