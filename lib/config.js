...
class Config {
  constructor(config) {
    ...
    this._config.baseDir = this._config.baseDir || this.baseDir;
    this.configList = [this._config];
    this.packs = {};
    this.webpackInfo = {};
    ...
    this.logger = new Logger(this._config.logger, this);
    this.adapter = new Adapter(this);
    this.initZero(this._config);
    this.initEntry(this._config);
    this.initialize(this._config);
    this.initEnv(this._config);
  }
