...
exports.getDllWebpackConfig = (config, option = {}) => {
  ...
  if (config.dll) {
    ...
    dllArray.forEach(item => {
      const builderConfig = Object.assign({}, dllConfig, { node, cache, entry: {}, dll: item, publicPath, buildPath, alias, externals, install, cdn, loaders, plugins }, item.webpackConfig);
